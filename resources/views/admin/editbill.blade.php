                ...
                <div class="ibox-content">
                    <form method="post" action="{{ url('admin/bill/'.$bill->id) }}" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-lg-10"><input type="text" class="form-control" name="phonenumber" readonly value="{{$bill->phonenumber}}" required></div>
                        </div>
                       <div class="form-group col-sm-6">
                            <label class="col-lg-2 control-label">Email</label>
                            <div class="col-lg-10"><input type="text" class="form-control" name="email" readonly value="{{$bill->email}}" required></div>
                        </div>
                        <div class="form-group col-sm-6">
                            <label class="col-lg-2 control-label">Ngày mua</label>
                            <div class="col-lg-10"><input type="text" class="form-control" name="text" readonly value="{{$bill->created_at}}" required></div>
                        </div>
                        <div class="form-group col-sm-6">
                            <label class="col-lg-2 control-label">Tổng tiền</label>
                            <div class="col-lg-10"><input type="number" class="form-control" name="date" readonly value="{{$bill->payment + $bill->shipping}}" required></div>
                        </div>
                        <div class="form-group col-sm-6">
                            <label class="col-lg-2 control-label">Phí ship</label>
                            <div class="col-lg-10"><input type="number" class="form-control" name="date" readonly value="{{$bill->shipping}}" required></div>
                        </div>
                        <div class="form-group col-sm-6">
