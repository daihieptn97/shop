...
<!-- Mainly scripts -->
    ...
    <!-- Flot -->
    <script src="<?php echo e(URL::asset('js/plugins/flot/jquery.flot.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('js/plugins/flot/jquery.flot.tooltip.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('js/plugins/flot/jquery.flot.spline.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('js/plugins/flot/jquery.flot.resize.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('js/plugins/flot/jquery.flot.pie.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('js/plugins/flot/jquery.flot.symbol.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('js/plugins/flot/jquery.flot.time.js')); ?>"></script>
